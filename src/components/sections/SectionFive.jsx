...
const SectionFive = () => {
  ...
  return (
    <div className="lg:mt-[15rem] mt-[10rem] md:mt-[8rem] lg:flex lg:flex-col lg:gap-[5rem]">
      <div className="lg:flex lg:flex-col lg:gap-4">
        <h2 className="lg:text-xl text-blue-400 border-b-[.2rem] border-blue-300 bg-blue-100 w-20 mb-4">Support</h2>
      ...
      <div className="lg:flex md:flex md:justify-between  lg:justify-between">
        {cardItem.map((item) => (
          <div className="lg:flex lg:flex-col mt-[2rem] lg:gap-4 leading-6 bg-[#fcfcfc] p-8 w-[20rem] lg:w-[30%] md:w-[31%] md:h-[20%] lg:h-[25%] drop-shadow-md rounded hover:-translate-y-5 hover:scale-100 transition duration-700 ease-in-out hover:bg-blue-50 cursor-pointer">
