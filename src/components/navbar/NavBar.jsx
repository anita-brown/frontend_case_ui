...
const NavBar = () => {
    ...
    return (
        <div className='mt-4 border-b-[.8px] flex flex-row lg:flex w-full text-[.6rem] md:text-[.8rem] lg:text-[1rem] gap-2 pb-4 items-center lg:justify-end md:justify-end cursor-pointer'>
